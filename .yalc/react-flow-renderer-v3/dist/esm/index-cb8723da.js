        ...
        case 'dimensions':
          {
            ...
            if (typeof currentChange.dimensions !== 'undefined') {
              console.log('THE CURRENT CHANGES:', currentChange);
        ...
        var changes = updates.reduce(function (res, update) {
          ...
          if (node) {
            ...
            if (doUpdate) {
              ...
              console.log('HERE WE CAN SEE THE HANDLERS:', handleBounds);
              res.push({
                id: node.id,
                type: 'dimensions',
...
//# sourceMappingURL=index-cb8723da.js.map
